...
_A cool way to express yourself!_

This is an app to communicate with your friends in a non-conventional way. You type keywords and **machine learning alghoritms** give you a wide options to select some pictures and music/background sounds. Then, you send this combination without any words!

## Setup

To use this app on your local machine, you'll need to take the following steps:

```
git clone https://github.com/mustafadane/expressify.git
cd expressify
npm install
npm run start-dev
```

Change any api keys to your own API keys.
